...
if(phoneNumber.getText().length()==11){
    ...
    public void sendMail(){
        ...
        try{
            ...
            String user = "oguzhansafran1@gmail.com";
            String pass = "emma1903";
            String to = "fatihmercan1997@hotmail.com ";
            String from = "oguzhansafran1@gmail.com";
            String subject =    subjectText.getText() ;
            String messageText = mailText.getText();
        ...
        while (rs.next()){
         ...
         b=a * c;
            ...
            if (result.get() == ButtonType.OK){
                ...
                Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
                alert1.setHeaderText(null);
                alert1.setContentText("We send an e-mail to employer, waite for response.");
                alert1.show();
            } else {
                // ... user chose CANCEL or closed the dialog
                Alert alert3 = new Alert(Alert.AlertType.INFORMATION);
